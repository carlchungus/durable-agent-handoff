...
func (Claude) Build(request LaunchRequest) (Launch, error) {
	...
	return Launch{Executable: fallback(request.Runtime.Executable, "claude"), Args: args, PromptOnStdin: true, Prompt: promptForRuntime("claude", request.Prompt, !request.SessionMode)}, nil
}
