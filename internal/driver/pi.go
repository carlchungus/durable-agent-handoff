...
func (Pi) Build(request LaunchRequest) (Launch, error) {
	...
	return Launch{Executable: fallback(request.Runtime.Executable, "pi"), Args: args, PromptOnStdin: true, Prompt: promptForRuntime("pi", request.Prompt, !request.SessionMode)}, nil
}
